...
export declare class HeroMaterial extends MBaseMaterial {
    static shaderName: string;
    static defaultMaterial: HeroMaterial;
    ...
    static SHADERDEFINE_SHADOWTEXTURE: number;
    ...
    shadowTexture: laya.resource.BaseTexture;
