...
namespace GPUSkingings
{
    ...
    public class GPUSkinningMeshExport
    {

        public string version = "LAYAMODEL:GPUSkining_05";
        private int versionByteLength = 2 + 12;
        public Mesh mesh;

        private _Data _Data = new _Data();
        private _BLOCK _BLOCK = new _BLOCK();
        //private List<string> _strings = new List<string>(new string[] { "MESH", "SUBMESH", "GPUSKinning_Mesh_Hero_1001_Dianguanglongqi_Skin1", "POSITION,NORMAL,UV,UV1,UV2,TANGENT" });
        private List<string> _strings = new List<string>(new string[] { "MESH", "SUBMESH", "GPUSKinning_Mesh_Hero_1001_Dianguanglongqi_Skin1", "POSITION,NORMAL,UV,UV1,UV2" });
        ...
        {
            meshName = mesh.name;
            meshName = meshName.Replace("_Mesh_", "_") + "_Mesh";
            ...
            {
                dir = AssetDatabase.GetAssetPath(mesh);
